...
<details>
  ...
  <p align="center">You can find some of my projects below. Note that these are mainly used for administration and automation tasks.</p>
...
| [elk-siem](https://github.com/dikayx/elk-siem)             | A lightweight SIEM solution based on the ELK stack, Docker, Winlogbeat & Sysmon.               | ![GitHub Repo stars](https://img.shields.io/github/stars/dikayx/elk-siem?style=flat)       | ![Docker](https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=white)             |
